      ...
      startGeneration: (jobId: string, courseId?: string) => {
        ...
        const activeGeneration: ActiveGeneration = {
          ...
          progress: {
            jobId,
            stages: {
              documentAnalysis: { id: 'analysis', name: 'Document Analysis', status: 'pending', progress: 0, icon: 'book', description: 'Analyzing uploaded documents' },
              contentExtraction: { id: 'extraction', name: 'Content Extraction', status: 'pending', progress: 0, icon: 'extract', description: 'Extracting content from documents' },
              aiProcessing: { id: 'processing', name: 'AI Processing', status: 'pending', progress: 0, icon: 'cpu', description: 'Processing content with AI' },
              structureGeneration: { id: 'generation', name: 'Structure Generation', status: 'pending', progress: 0, icon: 'structure', description: 'Generating course structure' },
            },
            overallProgress: 0,
            isComplete: false,
            hasError: false,
